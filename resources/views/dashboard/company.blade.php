            ...
            <div class="box">
                <div class="box-body">
                    <div style="display: flex;align-content: center;align-items: center;justify-content: space-between;padding: 50px">
                        <div style="width: 40%">
                            <h3>Perusahaan anda memiliki {{ $pending_apply_job }} lamaran untuk segera ditinjau.</h3>
                            <p>Segera tinjau lamaran yang masuk diperusahaan anda.</p>
                        ...
                        <div class="d-flex flex-row align-items-center justify-content-center">
                            <div class="card" >
                                <div class="card-body d-flex flex-column align-items-center justify-content-center" style="display:flex;align-items: center;flex-direction: column;">
                                    ...
                                    <h4 class="mb-3 text-center">Tidak ditemukan pekerjaan diperusahaan anda</h4>
