        ...
        <div class="box-body table-responsive no-padding">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Daftar Penjualan Barang</a></li>
                    <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Pengiriman</a></li>
                            ...
                            <tbody>
                                @forelse ($results as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->discount_value ? number_format($row->discount_value, 0, ',', '.') : '-' }}
                                        </td>
                        ...
                        <div class="box box-solid">
                            ...
                            <div class="box-body">
                                <form class="form-horizontal" method="post" id="form" enctype="multipart/form-data"
                                    action="{{ url('admin/sales_order_details/add-shipment') }}">
                                    @csrf
                                    <input type="hidden" name="return_url" value="{{ url()->full() }}">
                                    <input type="hidden" name="ref_id" value="{{ $parent->id }}">
                                    <input type="hidden" name="ref_table" value="sales_orders">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs btn-warning btn-delete" title="Delete"
                                                        ...
                                                        function(){  location.href=&quot;{{ CRUDBooster::mainpath('delete-shipment/' . $shipment->id) }}?&quot; });"><i
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data"
                                action="{{ url('admin/sales_order_details/update-tax') }}">
                                @csrf
                                <input type="hidden" name="return_url" value="{{ url()->full() }}">
                                <input type="hidden" name="ref_id" value="{{ $parent->id }}">
                                <input type="hidden" name="ref_table" value="sales_orders">
